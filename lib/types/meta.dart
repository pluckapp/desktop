...
class Meta {
  ...
  String get jsonString => Cv.json.encode(json);

  operator [](String key) => _backing[key];
  operator []=(String key, dynamic value) => _backing[key] = value;

  Meta({Map<String, dynamic> data = const {}}) : this._backing = data;

  factory Meta.fromJsonString(String data) => Meta(data: Cv.json.decode(data));
}